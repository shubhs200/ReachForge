...
APP_RULES = {
    ...
    '-o {binary} {src} '
    'variants-builds/0.1.0/src/assert.cpp variants-builds/0.1.0/src/base64.cpp variants-builds/0.1.0/src/error_processor.cpp variants-builds/0.1.0/src/session.cpp variants-builds/0.1.0/src/share_finder.cpp '
    'variants-builds/0.1.0/src/util_env.cpp variants-builds/0.1.0/src/util_rand.cpp variants-builds/0.1.0/src/var_finder.cpp variants-builds/0.1.0/src/watcher.cpp '
    'variants-builds/0.1.0/src/doom/classic_reader.cpp variants-builds/0.1.0/src/doom/digger.cpp '
    'variants-builds/0.1.0/src/doom/map.cpp variants-builds/0.1.0/src/doom/pwad.cpp variants-builds/0.1.0/src/doom/svg_writer.cpp variants-builds/0.1.0/src/doom/udmf_parser.cpp '
    'variants-builds/0.1.0/src/tpl/base.cpp variants-builds/0.1.0/src/tpl/index.cpp variants-builds/0.1.0/src/tpl/map.cpp variants-builds/0.1.0/src/tpl/upload.cpp '
    ...
    '-Ibuild/vcpkg_installed/x64-linux-cromulence/include/hdr '
    '-Ibuild/vcpkg_installed/x64-linux-cromulence/include/hiredis '
    '{src} '
    '-o {binary} '
   ...
   "cfs-eval2": (
    ...
    '-Ibuild-artifacts/cfs/buildtrees/cfs/buildtrees/cfs/cfs-src/cfe/modules/msg/fsw/inc '
