...
APP_RULES = {
    ...
    '-o {binary} {src} '
    'variant-builds/0.1.0/src/assert.cpp variant-builds/0.1.0/src/base64.cpp variant-builds/0.1.0/src/error_processor.cpp variant-builds/0.1.0/src/session.cpp variant-builds/0.1.0/src/share_finder.cpp '
    'variant-builds/0.1.0/src/util_env.cpp variant-builds/0.1.0/src/util_rand.cpp variant-builds/0.1.0/src/var_finder.cpp variant-builds/0.1.0/src/watcher.cpp '
    'variant-builds/0.1.0/src/doom/classic_reader.cpp variant-builds/0.1.0/src/doom/digger.cpp '
    'variant-builds/0.1.0/src/doom/map.cpp variant-builds/0.1.0/src/doom/pwad.cpp variant-builds/0.1.0/src/doom/svg_writer.cpp variant-builds/0.1.0/src/doom/udmf_parser.cpp '
    'variant-builds/0.1.0/src/tpl/base.cpp variant-builds/0.1.0/src/tpl/index.cpp variant-builds/0.1.0/src/tpl/map.cpp variant-builds/0.1.0/src/tpl/upload.cpp '
