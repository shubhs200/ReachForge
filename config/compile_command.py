...
APP_RULES = {
    ...
    '-Ivcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/inc '
    '-Ivcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/src '
    '-Ivcpkg/buildtrees/cfs/cfs-src/cfe/modules/core_api/fsw/inc '
    '-Ivcpkg/buildtrees/cfs/cfs-src/cfe/modules/core_private/fsw/inc '
    '-Ivcpkg/buildtrees/cfs/cfs-src/cfe/modules/msg/fsw/inc '
    '-Ivcpkg/buildtrees/cfs/cfs-src/cfe/modules/msg/option_inc '
    '-Ivcpkg/buildtrees/cfs/cfs-src/osal/src/os/inc '
    '-Ivcpkg/buildtrees/cfs/cfs-src/psp/fsw/inc '
    '-Ivcpkg/buildtrees/cfs/cfs-src/cfe/build/custom/default_cpu1/osal/inc '
    '-Ivcpkg/buildtrees/cfs/cfs-src/cfe/build/inc '
    '-Ivcpkg/buildtrees/cfs/cfs-src/cfe/build/custom/default_cpu1/inc '
    '{src} '
    'vcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/src/mm_app.c '
    'vcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/src/mm_dump.c '
    'vcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/src/mm_load.c '
    'vcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/src/mm_utils.c '
    'vcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/src/mm_mem8.c '
    'vcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/src/mm_mem16.c '
    'vcpkg/buildtrees/mm/src/d31fe7a035-523bcc0982.clean/fsw/src/mm_mem32.c '
    '-o {binary}"'
    ),
