...
APP_RULES = {
    ...
    "challenge": (
        'bash -lc "AFL_USE_ASAN=1 '
        'afl-clang-fast -g -O0 -fno-omit-frame-pointer -fsanitize=address,undefined '
        '-I. -Iapp/src -Ibuild-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/include '
        '{src} '
        '-o {binary} '
        '-Wl,--start-group '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libturbojpeg.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libtiff.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libopenjp2.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libjpeg.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libpng16.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libwebp.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libgif.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libraw_r.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libmagic.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libjasper.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/liblcms2.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/libz.a '
        'build-artifacts/challenge/build/vcpkg_installed/x64-linux-cromulence/lib/liblzma.a '
        '-Wl,--end-group '
