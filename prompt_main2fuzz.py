...
def build_afg_prompt(root: Path, out_dir: Path, afg_path: Path) -> Optional[Path]:
    ...
    lines.append("- FORBIDDEN in this target: string.unpack, table.unpack, and executing Lua code strings to reach unpack. Only call global unpack via lua_getglobal + lua_pcall.")
